from ezcode.Linked.List import FORWARD_LINK, BACKWARD_LINK, BIDIRECTION_LINK
from ezcode.Linked.List.algorithm import SinglyLinkedListAlgorithm, DoublyLinkedListAlgorithm
