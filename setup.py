...
setuptools.setup(
    name="eztree",                                  # This is the name of the package
    version="0.0.10",                                # The initial release version
    author="Zheng Gao",                             # Full name of the author
    description="Easy Binary Tree",
    url="https://github.com/zheng-gao/ez_tree",
    project_urls={
        "Bug Tracker": "https://github.com/zheng-gao/ez_tree/issues",
    },
    ...
    py_modules=["eztree"],                           # Name of the python package
